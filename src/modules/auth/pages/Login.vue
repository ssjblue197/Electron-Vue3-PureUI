<template>
  <div class="wrapper flex items-center">
    ...
    <!-- <div class="relative hidden h-full xl:block">
      <img
        src="/banner2.webp"
        alt="banner"
    ...
    <!-- <div
      class="relative hidden h-full flex-1 items-center justify-center overflow-hidden bg-[#53389E] md:flex"
    >
      <div
        class="flex flex-col items-center gap-4xl text-center xl:gap-6xl"
      >
        <img
          ...
          class="h-auto w-[80%]"
        />
        <div class="flex max-w-[300px] flex-col gap-md">
          <span class="text-xl font-medium text-white">
            PureUI </span
          ><span class="text-md font-medium text-white">
            Swift is your gateway to rapid fast fulfillment
            minus the steep investment.
          </span>
        </div>
      </div>
    </div> -->
